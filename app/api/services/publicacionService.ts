...
import { ServicioSchema } from '../models/Servicio';
import mongoose from "mongoose";

const publicacion= mongoose.model('publicaciones',ServicioSchema);
export default class publicacionService {
    
    public createPublicacion(publicacionParams: interfaceServicio, callback: any) {
    ...
    public updatePublicacion(publicacionParams: interfaceServicio, callback: any) {
